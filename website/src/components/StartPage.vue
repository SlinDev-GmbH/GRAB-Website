	...
	<div id="homepage">
		...
		<main>
			...
			<section class="section-fade">
				...
				<p>
					GRAB is a VR multiplayer parkour game. Climb, jump, slide and swing through the levels to reach the end, but don't fall
					or touch the lava!
				</p>
			</section>
			<section class="section-fade">
				...
				<p>
					A core component of GRAB is the level editor that lets you and your friends create your own levels together and upload
					them for everyone else to play. View community creations on the level browser!
				</p>
				<div class="buttons">
