...
<template>
    <button v-if="isSuperModerator" :class="isModerator ? 'remove-moderator-button' : 'make-moderator-button'" @click="toggleModerator">{{ isModerator ? "Remove" : "Make" }} Moderator</button>
</template>
